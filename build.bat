...
::BUILD
"tools\nuget.exe" restore AppForSharePointOnlineWebToolkit.sln
"%MSBUILDDIR%msbuild.exe" "src\AppForSharePointOnlineWebToolkit\AppForSharePointOnlineWebToolkit.csproj" /t:ReBuild /p:Configuration=Release;TargetFrameworkVersion=v4.5;DefineConstants="TRACE;NET45";OutPutPath=bin\Release\net45\
