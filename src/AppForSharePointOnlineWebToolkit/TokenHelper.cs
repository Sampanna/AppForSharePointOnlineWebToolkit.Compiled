...
namespace AppForSharePointOnlineWebToolkit
{
    public static class TokenHelper
    {
        ...
        private static readonly string ClientId = string.IsNullOrEmpty(SpoConfigManager.AppSettings.Get("ClientId")) ? SpoConfigManager.AppSettings.Get("HostedAppName") : SpoConfigManager.AppSettings.Get("ClientId");

        private static readonly string IssuerId = string.IsNullOrEmpty(SpoConfigManager.AppSettings.Get("IssuerId")) ? ClientId : SpoConfigManager.AppSettings.Get("IssuerId");
        private static readonly string HostedAppHostNameOverride = SpoConfigManager.AppSettings.Get("HostedAppHostNameOverride");
        private static readonly string HostedAppHostName = SpoConfigManager.AppSettings.Get("HostedAppHostName");
        private static readonly string ClientSecret = string.IsNullOrEmpty(SpoConfigManager.AppSettings.Get("ClientSecret")) ? SpoConfigManager.AppSettings.Get("HostedAppSigningKey") : SpoConfigManager.AppSettings.Get("ClientSecret");
        private static readonly string SecondaryClientSecret = SpoConfigManager.AppSettings.Get("SecondaryClientSecret");
